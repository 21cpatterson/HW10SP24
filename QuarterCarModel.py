...
class CarModel():
    ...
    def __init__(self):
        ...
        self.m2 = 100  # mass of wheel in kg
        self.c1 = 500  # damping coefficient in N*s/m
        self.k1 = 30000  # spring constant of suspension in N/m
        self.k2 = 100000  # spring constant of tire in N/m
        self.v = 60  # velocity of car in kph


        self.mink1 = (450 * 9.81 * 3 / 39.97)  #If I jack up my car and release the load on the spring, it extends about 3 inches
        self.maxk1 = (450 * 9.81 * 6 / 39.37)  #What would be a good value for a soft spring vs. a stiff spring?
        self.mink2 = (20 * 9.81 * 0.75 / 39.37)  #Same question for the shock absorber.
        self.maxk2 = (20 * 9.81 * 1.5 / 39.97)
        self.accel = None
        self.accelMax = 2 * 9.81
        self.accelLim = self.accelMax
        self.SSE = 0.0
...
class CarController():
    ...
    def ode_system(self, X, t):
        ...
        x1ddot = (1 / m1) * (-c1 * x1dot - k1 * (x1 - y))
        x2ddot = (1 / m2) * (k1 * (x1 - x2) - c1 * (x2dot - x1dot) - k2 * x2)
    ...
    def calculate(self, doCalc=True):
        ...
        self.model.mink1 =  self.model.m1     # Example value, replace with appropriate calculation
        self.model.maxk1 =  self.model.k1 * 10 # Example value, replace with appropriate calculation
        self.model.mink2 =  self.model.m2 *10  # Example value, replace with appropriate calculation
        self.model.maxk2 =  self.model.k2   # Example value, replace with appropriate calculation
    ...
    def OptimizeSuspension(self):
        ...
        """
        # Step 1:
        # Already called self.calculate(doCalc=False) in the original code

        # Step 2:
        # Initial guess for k1, c1, and k2
